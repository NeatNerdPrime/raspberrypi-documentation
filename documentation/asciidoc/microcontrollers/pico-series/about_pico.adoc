...
For the full `libcyw43` commercial licence, see https://github.com/georgerobotics/cyw43-driver/blob/055d64274b014dd7b1c2fc94d26e8a18face7124/LICENSE.RP[cyw43-driver in GitHub]. For the full `BTstack` commercial licence, see https://github.com/raspberrypi/pico-sdk/blob/master/src/rp2_common/pico_btstack/LICENSE.RP[pico_btstack in GitHub].
