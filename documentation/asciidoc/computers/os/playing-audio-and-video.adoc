...
NOTE: using `kmsprint` without parameters only queries the first card found. This may therefore not list all attached displays on Raspberry Pi 5 and later models. See xref:../computers/os.adoc#kmsprint[kmsprint.]
