...
. Lift the module bay straight upwards. The four guideposts at the corners ensure that you can do this without fouling the pogo pins.
. Use the tweezers to grip a pogo pin that you want to replace and pull it straight upwards and out of the collar.
. Use the tweezers to insert the replacement pogo pin into the collar. Ensure that the larger diameter end with a hole in it goes into the collar first and that the smaller diameter, solid end points upwards.
...
.. Position it with the Raspberry Pi logo facing upwards and orientated towards you and away from the open lid.
